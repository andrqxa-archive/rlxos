...
func parseColorStr(s string) graphics.Color {
	...
	if strings.HasPrefix(s, "theme.") {
		...
		case "color.accent.hover":
			return graphics.DefaultTheme.PrimaryHover
		case "primaryactive":
			return graphics.DefaultTheme.PrimaryActive
		case "secondary":
			return graphics.DefaultTheme.Secondary
		case "color.control.fill":
			return graphics.DefaultTheme.Secondary
		case "border":
			return graphics.DefaultTheme.Border
		case "color.stroke.hairline":
			return graphics.DefaultTheme.Border
		case "borderfocused":
			return graphics.DefaultTheme.BorderFocused
		case "color.stroke.focus":
			return graphics.DefaultTheme.BorderFocused
		case "inputbackground":
			return graphics.DefaultTheme.InputBackground
		case "inputforeground":
			return graphics.DefaultTheme.InputForeground
		case "buttontext":
		...
		case "color.surface.sidebar":
			return graphics.DefaultTheme.SurfaceSidebar
		case "color.stroke.divider":
			return graphics.DefaultTheme.StrokeDivider
		case "color.text.secondary":
			return graphics.DefaultTheme.TextSecondary
		case "color.text.muted":
			return graphics.DefaultTheme.TextMuted
		case "color.text.disabled":
			return graphics.DefaultTheme.TextDisabled
		case "color.control.hover":
			return graphics.DefaultTheme.ControlHover
		case "color.control.pressed":
			return graphics.DefaultTheme.ControlPressed
		case "color.accent.subtle":
			return graphics.DefaultTheme.AccentSubtle
		case "color.semantic.success":
			return graphics.DefaultTheme.Success
		case "color.semantic.warning":
			return graphics.DefaultTheme.Warning
		case "color.semantic.danger":
			return graphics.DefaultTheme.Danger
		}
	}
