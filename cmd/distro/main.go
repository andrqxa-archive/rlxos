...
func runShell(args []string) error {
	...
	client.OnShellOutputEvent(func(ev distroapi.ShellOutputEvent) {
	...
	client.OnShellExitEvent(func(ev distroapi.ShellExitEvent) {
...
func printRunOutput(result distroapi.RunResult) {
